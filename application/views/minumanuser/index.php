            ...
            <div class="makanan">
                <div class="container py-3">
                    <div class="container px-4 py-4" id="hanging-icons">
                        <div class="row">
                            <div class="col">
                                <h2 class="pb-2 "><b>Daftar Resep Minuman</b></h2>
                            </div>
                            <div class="col">
                                ...
                                <div class="col d-flex align-items-start">
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="<?= base_url(); ?>minumanuser/lihat/<?= $rsp['id_resep']; ?>"><button class="btn btn-outline-warning btn-md-2"><b>Lihat Resep</b></button></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach ?>

...
class Makananuser extends CI_Controller
{
    ...
    public function Index()
    {
        ...
        $data['judul'] = 'Resep Makanan';
        $data['resep'] = $this->Resep_model->usermakanan();
        if ($this->input->post('keyword')) {
            $data['resep'] = $this->Resepuser_model->search();
        }
        $this->load->view('tempuser/headuser', $data);
        $this->load->view('makananuser/index', $data);
    ...
    public function lihat($id_resep)
    {
        ...
        $this->load->view('makananuser/lihat', $data);
